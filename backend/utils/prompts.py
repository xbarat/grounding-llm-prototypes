...
def zero_shot_prompt(df, question: str) -> str:
    prompt = f"""
    I have a DataFrame with TypeRacer performance data. Please help me answer this question:
    {question}

    For any visualizations, please use seaborn's set_theme() with style='whitegrid', 'darkgrid', 'white', or 'dark'.
